<template>
  <div class="simple-card grayscale-active grayscale-reverse-on-hover shadow-on-hover">
    <img
      class="card-image"
      src="http://placedog.net/1000/600"
    >
...
//// @use "@guebbit/css-ui/src/atoms/highlights/HighlightBelt.scss" with (
//    $size: 60px,
//);
//// @use "@guebbit/css-ui/src/atoms/typography/SimpleTextIcon.scss";
//// @use "@guebbit/css-ui/src/molecules/cards/SimpleCard.scss" with (
